...
(function(){
  ...
  async function download(){
    try{
      ...
      applying=true;window.cats=remote.cats;window.dishes=remote.dishes;saveLocal();lastFp=remoteFp;lastRemoteUpdated=remoteTime;redraw();console.log('FA sync download OK',row.updated_at||'');return true;
  ...
  function install(){
    ...
    if(!window.persist.__faSyncV6){
      ...
      wrappedPersist.__faSyncV6=true;window.persist=wrappedPersist;
    }
